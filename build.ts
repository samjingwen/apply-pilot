...
await cp(`${root}/extension/background.js`, `${buildDir}/background.js`);
await cp(`${root}/extension/content.js`, `${buildDir}/content.js`);
await cp(`${root}/extension/manifest.json`, `${buildDir}/manifest.json`);
await cp(`${root}/images/ai-content-generator.png`, `${buildDir}/images/ai-content-generator.png`);
